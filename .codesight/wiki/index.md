...
_Generated 2026-06-07 — re-run `npx codesight --wiki` if the codebase has changed._
...
- Models: **3**
- Components: **82**
- Env vars: **39** required, **176** with defaults
...
---
_Last compiled: 2026-06-07 · 20 articles · [codesight](https://github.com/Houseofmvps/codesight)_