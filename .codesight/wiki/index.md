...
_Generated 2026-05-31 — re-run `npx codesight --wiki` if the codebase has changed._
...
- Models: **3**
- Components: **81**
- Env vars: **32** required, **119** with defaults
...
---
_Last compiled: 2026-05-31 · 18 articles · [codesight](https://github.com/Houseofmvps/codesight)_