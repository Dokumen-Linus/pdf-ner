---
name: pytest
description: Use to plan advanced pytest patterns including custom markers, plugins, hooks, parallel execution, and pytest-xdist or when implementing custom test infrastructure, optimizing test execution, or building reusable test utilities
---
...
- `unit-testing` - Basic python and typescript patterns and AAA structure

## References

- [Pytest patterns](references/pytest-patterns.md) - alternative pattern resource without typescript or generalized best practices
