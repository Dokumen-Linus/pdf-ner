...
description: Use to write custom middleware, intercepting requests/responses, adding headers, logging, authentication, or any request processing pipeline in FastAPI
---
