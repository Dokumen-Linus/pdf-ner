...
- [tanstack-start-core/middleware](../middleware/SKILL.md) — middleware for server routes
- [tanstack-start-core/server-functions](../server-functions/SKILL.md) — alternative for RPC-style calls
