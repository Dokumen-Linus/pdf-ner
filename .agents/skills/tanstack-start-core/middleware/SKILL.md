...
- [tanstack-start-core/server-functions](../server-functions/SKILL.md) — what middleware wraps
- [tanstack-start-core/server-routes](../server-routes/SKILL.md) — middleware on API endpoints
