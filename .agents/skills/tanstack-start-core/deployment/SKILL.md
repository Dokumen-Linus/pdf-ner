...
- [tanstack-start-core/server-routes](../server-routes/SKILL.md) — API endpoints for sitemaps, robots.txt
- [tanstack-start-core/execution-model](../execution-model/SKILL.md) — SSR affects where code runs
