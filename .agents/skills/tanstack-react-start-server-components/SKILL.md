...
description: >-
  ...
  @tanstack/tanstack-react-start/rsc, renderServerComponent,
...
3. Inspect server boundaries: `createServerFn`, `createServerOnlyFn`, `.server.*`, and imports from `@tanstack/tanstack-react-start/server`.
