...
description: Use to plan and create page transitions, animate route changes, create shared element animations, animate enter/exit of components, animate list reorder, implement directional (forward/back) navigation animations. Explains React's <ViewTransition> component, `addTransitionType`, and CSS view transition pseudo-elements
license: MIT
metadata:
  author: vercel
  version: "1.0.0"
