---
name: tanstack-ai-media-generation
description: >
...
> **Dependency note:** This skill builds on tanstack-ai. Read it first for critical rules.
...
- See also: **tanstack-ai-adapter-configuration/SKILL.md** -- Each media
