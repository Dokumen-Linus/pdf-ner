---
name: zustand
description: Use for Zustand state management for React. Covers store creation, selectors, TypeScript patterns, middleware (persist/devtools/immer), slices, advanced patterns (optimistic updates, undo/redo, context integration, subscriptions), and anti-patterns.
---
