---
name: tanstack-ai-ag-ui-protocol
description: >
...
This skill builds on tanstack-ai. Read it first for critical rules.
...
- See also: `tanstack-ai-custom-backend-integration/SKILL.md` -- Custom backends must implement SSE or HTTP stream format to work with TanStack AI client connection adapters.
