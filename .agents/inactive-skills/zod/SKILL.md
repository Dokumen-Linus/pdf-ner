---
name: zod
description: Use for validating API requests/responses, form data, defining type-safe schemas with runtime validation, transforming data, generating JSON Schema for OpenAPI, encountering missing validation errors, type inference issues, validation error handling problems
license: MIT
metadata:
  version: 2.0.0
