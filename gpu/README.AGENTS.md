# GPU Runpod Workers Agent Notes

## Purpose

- `gpu/` contains Runpod Serverless HTTP workers used for OCR.
- Workers expose the same request shape, return normalized JSON, and share helpers from `gpu/shared`.
