...
- Use instead of asyncio whenever possible: repo [agronholm/anyio](https://github.com/agronholm/anyio), [docs AnyIO](https://anyio.readthedocs.io/en/stable/threads.html#adjusting-the-default-maximum-worker-thread-count)
- Use instead of starlette.testclient or app.state whenver possible: from httpx import Async Client, repo [encode/httpx](https://github.com/encode/httpx), [docs](https://www.python-httpx.org/), examples [Kludex/fastapi-tips](https://github.com/Kludex/fastapi-tips)
