...
- How to run: copy `infra/aws/bootstrap-ec2/.env.example` to `infra/aws/bootstrap-ec2/.env.local` on the EC2 host, fill in `TUNNEL_TOKEN`, then run `bash infra/aws/bootstrap-ec2/bootstrap-ec2.sh`.
