...
# shellcheck source=infra/deploy-aws/ec2/setup-ecr.sh
. "${SCRIPT_DIR}/setup-ecr.sh"
# shellcheck source=infra/deploy-aws/ec2/setup-key-pair.sh
. "${SCRIPT_DIR}/setup-key-pair.sh"
# shellcheck source=infra/deploy-aws/ec2/setup-instance-profile.sh
. "${SCRIPT_DIR}/setup-instance-profile.sh"
# shellcheck source=infra/deploy-aws/ec2/setup-instance.sh
