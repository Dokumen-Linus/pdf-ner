...
- `packages/otel_py` is the shared observability toolkit for Python apps.
- It provides reusable low-level primitives and should not own application-specific telemetry policy.
