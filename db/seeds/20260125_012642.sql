INSERT INTO api.templates (txt, inserts, document_at_end) 
...
Document:', ARRAY['<PROJECT_DESCRIPTION>','<ENTITY_TYPES>','<DEFINITIONS>','<EXAMPLE_VALUES>','<CONSTRAINTS>','<IS_REQUIRED>','<IS_UNIQUE>'], true);